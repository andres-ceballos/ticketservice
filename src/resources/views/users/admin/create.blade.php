...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center bg-light">{{ __('Registro usuario') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('admin.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_ext" type="tel" class="form-control @error('phone_ext') is-invalid @enderror" name="phone_ext" value="{{ old('phone_ext') }}" required autocomplete="phone_ext">
